      ...
      <section className="grid grid-cols-1 gap-4">
        ...
        {filtered.map((customer) => (
          ...
          <Dialog key={customer.id}>
            <DialogTrigger asChild>
              <article className="rounded-[2.5rem] bg-white dark:bg-zinc-900 border border-black/5 dark:border-white/10 shadow-xl shadow-black/5 p-5 touch-card group relative overflow-hidden">
                ...
                <div className="flex justify-between items-start mb-4">
                   <div>
                      <h2 className="text-xl font-black text-foreground leading-tight">{customer.fullName}</h2>
                ...
                <div className="flex gap-2">
                   ...
                   <div className="flex-1 bg-primary/5 rounded-2xl p-3 text-center border border-blue-600/10">
                      ...
                      <p className="text-sm font-black text-primary">{customer.totalEmptyCylindersReturned}</p>
                   </div>
                   <div className="flex items-center justify-center bg-primary h-12 w-12 rounded-2xl text-white">
            ...
            <DialogContent aria-describedby={undefined} className="fixed inset-0 z-[100] bg-background p-6 flex flex-col animate-in fade-in zoom-in-95 duration-300 overflow-y-auto">
              ...
              <div className="space-y-6">
                 ...
                 {/* Stats Grid */}
                 <div className="grid grid-cols-2 gap-3">
                    <div className="bg-zinc-50 dark:bg-zinc-900 rounded-2xl p-4 text-center border border-black/5 dark:border-white/5">
                       <p className="text-[10px] font-bold uppercase text-muted-foreground mb-1">Total Cylinders</p>
                       <p className="text-xl font-black text-foreground">{customer.totalCylindersReceived}</p>
                    </div>
                    <div className="bg-zinc-50 dark:bg-zinc-900 rounded-2xl p-4 text-center border border-black/5 dark:border-white/5">
